...
export default function Q9({ setStep, values, isShowPlaceholder }) {
  const {
  ...
  const options = [
    'Number of Referrals',
    'Number of Website Visits Unique',
    'Website Bounce Rate',
      ...
      <Box p={'4'} bg="white" border={'1px solid #E4E5E7'}>
        <Box pl={'6'} pr={'10'}>
          <Text fontSize={'16px'} fontWeight={'bold'} mb={'5'}>
            9. Please select the 4 most important marketing measurements for
            your business:
          </Text>
          <Formik
            enableReinitialize
            ...
            onSubmit={async (values, actions) => {
              const oldAns = strengthsOpportunities.part3?.q9?.answers;
              ...
              if (submitBtn === 'Continue') {
                ...
                const q9 = {
                  ...strengthsOpportunities?.part3?.q9,
                  answers,
                };

                let data = {
                  'section3.part3.q9.answers': answers,
                ...
                if (status) {
                  ...
                  updateSection('strengthsOpportunities', 'part3', { q9 });
