...
export default function Part2Q3({ values, setStep, isShowPlaceholder }) {
	const {
	...
	return (
		<>
			...
			<Box p="4" bg="white">
				<Text>
					3. What are the business owners committing to in order to achieve the
				...
				<Box pl="6" pr="10">
					<Formik
						...
						onSubmit={async (values, actions) => {
							...
							const oldAns = quickStart?.part2?.q3?.answers;
							...
							if (submitBtn === 'Continue') {
								...
								let data = {
									'section1.part2.q3.answers': answers,
								...
								if (status) {
									...
									updateSection('quickStart', 'part2', { q3 });
									...
									<TableContainer mt="5" h="550px">
										<Table variant="unstyled">
											<Thead>
												<Tr>
													<Th></Th>
													<Th textTransform={'none'}>My Quarterly actions</Th>
													<Th textTransform={'none'} textOverflow={'wrap'}>
														Who is going to do it? (Business owener)
													</Th>
