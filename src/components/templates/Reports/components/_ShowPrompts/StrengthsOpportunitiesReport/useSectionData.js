...
export default function useSectionData() {
  ...
  return {
    ...
    CARD6: {
      ...
      list: [
        { label: 'Banking (inviting)', content: banking },
        {
          label: 'Marketing Spend',
          content: maketingSpent,
        },
        { label: 'Overhead Trf', content: overheadTrf },
        {
          label: 'Accumulation Trf',
          content: accumulationTrf,
        },
      ],
    },
    CARD7: {
    ...
    CARD9: {
      ...
      list: [
        ...
        },
        {
          ...
          content: `${strengthsOpportunities?.part3?.q6.answers[3]} hours`,
        },
      ],
    },
    CARD10: {
